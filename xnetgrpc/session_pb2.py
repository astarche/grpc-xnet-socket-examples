...
Session = _reflection.GeneratedProtocolMessageType('Session', (_message.Message,), {'DESCRIPTOR': _SESSION, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(Session)
DeviceProperties = _reflection.GeneratedProtocolMessageType('DeviceProperties', (_message.Message,), {'DESCRIPTOR': _DEVICEPROPERTIES, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(DeviceProperties)
EnumerateDevicesRequest = _reflection.GeneratedProtocolMessageType('EnumerateDevicesRequest', (_message.Message,), {'DESCRIPTOR': _ENUMERATEDEVICESREQUEST, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(EnumerateDevicesRequest)
EnumerateDevicesResponse = _reflection.GeneratedProtocolMessageType('EnumerateDevicesResponse', (_message.Message,), {'DESCRIPTOR': _ENUMERATEDEVICESRESPONSE, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(EnumerateDevicesResponse)
ReserveRequest = _reflection.GeneratedProtocolMessageType('ReserveRequest', (_message.Message,), {'DESCRIPTOR': _RESERVEREQUEST, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(ReserveRequest)
ReserveResponse = _reflection.GeneratedProtocolMessageType('ReserveResponse', (_message.Message,), {'DESCRIPTOR': _RESERVERESPONSE, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(ReserveResponse)
IsReservedByClientRequest = _reflection.GeneratedProtocolMessageType('IsReservedByClientRequest', (_message.Message,), {'DESCRIPTOR': _ISRESERVEDBYCLIENTREQUEST, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(IsReservedByClientRequest)
IsReservedByClientResponse = _reflection.GeneratedProtocolMessageType('IsReservedByClientResponse', (_message.Message,), {'DESCRIPTOR': _ISRESERVEDBYCLIENTRESPONSE, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(IsReservedByClientResponse)
UnreserveRequest = _reflection.GeneratedProtocolMessageType('UnreserveRequest', (_message.Message,), {'DESCRIPTOR': _UNRESERVEREQUEST, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(UnreserveRequest)
UnreserveResponse = _reflection.GeneratedProtocolMessageType('UnreserveResponse', (_message.Message,), {'DESCRIPTOR': _UNRESERVERESPONSE, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(UnreserveResponse)
ResetServerRequest = _reflection.GeneratedProtocolMessageType('ResetServerRequest', (_message.Message,), {'DESCRIPTOR': _RESETSERVERREQUEST, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(ResetServerRequest)
ResetServerResponse = _reflection.GeneratedProtocolMessageType('ResetServerResponse', (_message.Message,), {'DESCRIPTOR': _RESETSERVERRESPONSE, '__module__': 'session_pb2'})
_sym_db.RegisterMessage(ResetServerResponse)
_SESSIONUTILITIES = DESCRIPTOR.services_by_name['SessionUtilities']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n\x12com.ni.grpc.deviceB\x08NiDeviceP\x01\xaa\x02\x1fNationalInstruments.Grpc.Device'
